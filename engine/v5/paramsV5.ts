 ...
 * inflation IPC fusionnée (HCP), décisions BAM (PDF « Historique des décisions »).
 *
 * Voir modele_v5.html pour la méthode complète et les écarts-types.
 */
 ...
 * reproduire les décisions de Bank Al-Maghrib redonne exactement les séries du HCP. Les
 * sensibilités ne gouvernent que l'ÉCART produit lorsque le joueur s'écarte de ces décisions.
 *
 * `npx tsx engine/v5/validate.ts` mesure les deux régimes séparément.
 */
